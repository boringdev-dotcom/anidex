...
func GetSpeciesSeeds() []models.Species {
	return []models.Species{
		// LEGENDARY ANIMALS (Extremely Rare)
		{
			...
			BasePoints:         200,
			DifficultyLevel:    10,
			DefaultImageURL:    "https://images.unsplash.com/photo-1574844635225-f471d00dc4c5?w=800",
		...
		},
		{
			...
			BasePoints:         180,
			DifficultyLevel:    9,
			DefaultImageURL:    "https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?w=800",
		...
		},
		{
			...
			BasePoints:         220,
			DifficultyLevel:    10,
			DefaultImageURL:    "https://images.unsplash.com/photo-1561731216-c3a4d99437d5?w=800",
		...
		},
		{
			...
			BasePoints:         120,
			DifficultyLevel:    7,
			DefaultImageURL:    "https://images.unsplash.com/photo-1551731074-4c6e6bf55aa2?w=800",
		...
		},
		{
			...
			BasePoints:         160,
			DifficultyLevel:    9,
			DefaultImageURL:    "https://images.unsplash.com/photo-1548986409-e00addd3c37b?w=800",
		...
		// RARE ANIMALS (Hard to Find)
		{
			...
			BasePoints:         80,
			DifficultyLevel:    6,
			DefaultImageURL:    "https://images.unsplash.com/photo-1474511320723-9a56873867b5?w=800",
		...
		},
		{
			...
			BasePoints:         70,
			DifficultyLevel:    5,
			DefaultImageURL:    "https://images.unsplash.com/photo-1553883943-cb4aaf2d1b73?w=800",
		...
		},
		{
			...
			BasePoints:         90,
			DifficultyLevel:    7,
			DefaultImageURL:    "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=800",
		...
		// UNCOMMON ANIMALS (Moderate Difficulty)
		{
			...
			BasePoints:         40,
			DifficultyLevel:    4,
			DefaultImageURL:    "https://images.unsplash.com/photo-1551969014-7d2c4cddf0b6?w=800",
		...
		},
		{
			...
			BasePoints:         30,
			DifficultyLevel:    3,
			DefaultImageURL:    "https://images.unsplash.com/photo-1552728089-57bdde30beb3?w=800",
		...
		},
		{
			...
			BasePoints:         35,
			DifficultyLevel:    3,
			DefaultImageURL:    "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800",
		...
		// COMMON ANIMALS (Easy to Find)
		{
			...
			BasePoints:         15,
			DifficultyLevel:    1,
			DefaultImageURL:    "https://images.unsplash.com/photo-1589469575522-9f49dcd6b39e?w=800",
		...
		},
		{
			...
			BasePoints:         10,
			DifficultyLevel:    1,
			DefaultImageURL:    "https://images.unsplash.com/photo-1571652725381-d39b7ecf8e6d?w=800",
		...
		},
		{
			...
			BasePoints:         5,
			DifficultyLevel:    1,
			DefaultImageURL:    "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=800",
		...
		},
		{
			...
			BasePoints:         8,
			DifficultyLevel:    1,
			DefaultImageURL:    "https://images.unsplash.com/photo-1518717758536-85ae29035b6d?w=800",
